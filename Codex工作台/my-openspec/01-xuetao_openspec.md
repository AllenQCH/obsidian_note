---
title: xuetao_openspec
source: Codex工作台/my-openspec/01-xuetao_openspec.md
author: 笨笨
published:
created: 2026-07-22
description: 解释本地原始版 xuetao_openspec 的整体定位、目录职责、对象模型和执行流程。
...
`xuetao_openspec` 是原始版 OpenSpec 工作区。它不是一个单纯的规范文档仓，而是一个**跨 repo 的 AI 开发工作台 / 控制面**。
