---
title: "tool_trace_log_operator 填写样例"
...
1. 先用 [[21-tool_trace_log_operator-最小执行入口草案]] 检查这次输入能不能算标准化入口
2. 再把这篇当作填写示范
3. 最后把真实内容沉淀到 [[15-tool_trace_log_operator-真实案例记录模板]]
...
2. 如果后面发现有些字段经常填不出来，再回头调整 [[21-tool_trace_log_operator-最小执行入口草案]] 或 [[15-tool_trace_log_operator-真实案例记录模板]]。
