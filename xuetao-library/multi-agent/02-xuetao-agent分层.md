---
title: "xuetao agent分层"
aliases: ["xuetao agent分层"]
source: "/Users/heytea/Documents/xuetao的agetns/.codex/config.toml"
author: "Codex"
published:
created: 2026-06-05
description: "按来源工程原始职责归档 Xuetao 的 Agent 分层，不映射为本地目标 ID。"
...
这篇只记录 Xuetao 原型的来源事实。下面的标识符沿用对方工程原名，不代表本地运行时存在同名 Agent。
...
- 不做旧本地名称到目标名称的一一映射。
- Allen 当前结构统一看 [[my-multi-agents总览]]。
