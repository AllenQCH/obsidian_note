---
title: "LangChain 是什么"
source: "ai-related/orchestration 编排/02-agent/02-langchain.md"
author: "Allen"
published: 
created: 2026-05-07
description: "LangChain 可以理解成一个 **LLM 应用 / Agent 开发框架**。"
tags: ["obsidian-note", "tech-note", "agent", "tooling", "prompt", "context", "orchestration", "llm"]
type: "tech-note"
status: "processed"
---
# LangChain 是什么
...
偏上层，给你一套开发 LLM 应用/Agent 的通用抽象，比如 model、prompt、tool、middleware、agent 接口、各类 provider 集成。官方现在把它定位成“快速开始构建自定义 agent 和 LLM 应用”的入口。
